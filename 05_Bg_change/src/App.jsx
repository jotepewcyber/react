...
function App() {
  // we are using color as olive
  const [color, setColor] = useState("olive")

  return (
    //style ={{ this is syntax}}
    <div className="w-full h-screen duration-200 " style={{
      backgroundColor:color
    }}>
      <div className="fixed flex flex-
      wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg text-white rounded-2xl px-2 py-3">
          {/* we cant do button onClick=setColor("blue") bcz this will give a result of setColor function but it wants a function so we pass a function to it. */}
